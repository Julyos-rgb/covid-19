        ...
        <transition name="el-fade-in-linear">
            <el-card class="box-card" shadow="hover" style="text-align: center"    @keyup.enter.native="login" >
                <div slot="header" class="clearfix" style="text-align: center">
                    <h2 style="font-size: 1rem">疫情防控管理系统</h2>
                </div>
                ...
                success:(result)=>{
                 if (result=="用户名或者账号输入错误"){
                    ...
                    //  window.localStorage.setItem("id",id);
                     if (this.radio3==1)  window.location.href=' http://localhost:81/#/admin/home'
                     if (this.radio3==2)  window.location.href=' http://localhost:81/#/student/home'
                     if (this.radio3==3)  window.location.href=' http://localhost:81/#/teacher/home'
                 }
                }
            })
          }
